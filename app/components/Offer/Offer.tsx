const Offer = () => {
    return (
        <div className="flex items-center justify-center pt-24 pb-20 bg-black">
            <div className="text-center px-6">
                <h2 className="text-white text-2xl md:text-3xl font-semibold mb-4">
                    Explore ultimate feature with premium
                </h2>
                <p>
                    Tell us your Apple ID email address so we could we could
                    send you a TestFlight invitation directly.
                </p>
